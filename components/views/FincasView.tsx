...
/>
      ...
      <div className="mb-6 relative z-10 max-w-7xl mx-auto">
        <h1 className="font-display text-3xl text-foreground mb-1 text-yellow-400 tracking-wider">Fincas del Atlántico</h1>
      ...
      <div className="flex flex-col sm:flex-row gap-3 mb-6 relative z-10 max-w-7xl mx-auto">
        <div className="relative flex-1">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-2.5 rounded-xl bg-black/40 text-white text-sm placeholder:text-white/60 focus:outline-none focus:ring-2 focus:ring-ring"
          />
        </div>
          ...
          <div className="flex gap-2 overflow-x-auto">
            {tipos.map(tipo => (
              <button
                ...
                className={`shrink-0 px-6 py-2   rounded-xl text-sm font-medium  transition-all ${
                  filtroTipo === tipo
                    ? 'bg-primary text-white shadow-sm '
                    : 'bg-white/20 backdrop-blur-sm text-white hover:bg-white/80 hover:text-black'
                }`}
              >
      ...
      {fincasFiltradas.length === 0 ? (
        ...
        <>
          <p className="text-sm text-white mb-4 relative z-10 max-w-7xl mx-auto">
