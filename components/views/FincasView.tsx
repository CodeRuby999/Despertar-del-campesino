...
export function FincasView() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-8">
      {/* Header */}
      <div className="mb-6">
        <h1 className="font-display text-3xl text-foreground mb-1">Fincas del Atlántico</h1>
        <p className="text-muted-foreground">Descubre productores verificados que llevan su cosecha directamente a ti</p>
      </div>
